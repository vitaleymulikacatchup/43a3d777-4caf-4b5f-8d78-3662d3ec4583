...
export const metadata: Metadata = {
  ...
  description: "Professional photography services for portraits, weddings, and events. Capturing life's beautiful moments with artistic vision and technical excellence.",
  keywords: "photography, portraits, wedding photography, event photography, professional photographer, photo sessions",
  metadataBase: new URL("https://photogallery.com"),
  alternates: {
    canonical: "https://photogallery.com"
  },
  openGraph: {
    title: "PhotoGallery - Professional Photography Services",
    description: "Professional photography services for portraits, weddings, and events. Capturing life's beautiful moments with artistic vision and technical excellence.",
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763651362938-0e35enkk.jpg",
  ...
  twitter: {
    ...
    title: "PhotoGallery - Professional Photography Services",
    description: "Professional photography services for portraits, weddings, and events.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763651362938-0e35enkk.jpg"]
  },
  robots: {
    index: true,
    follow: true
